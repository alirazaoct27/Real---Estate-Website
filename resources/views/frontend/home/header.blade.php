...
<div class="main-box">
<div class="logo-box">
    <figure class="logo"><a href="{{ url('/') }}"><img src="{{ asset('frontend/assets/images/vibe_black.png') }}" alt=""></a></figure>
</div>
<div class="menu-area clearfix">
    ...
    <nav class="main-menu navbar-expand-md navbar-light">
        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
           ...
           <li class="dropdown"><a href="{{ route('featured.property') }}"><span>Property</span></a>
               <ul>
                   ...
                   <li><a href="{{ route('buy.property') }}">Buy Property </a></li>
                    ...
                    <li><a href="{{ route('agent.list') }}"><span>Agents </span></a> </li>

            <li><a href="{{ route('blog.list') }}"><span>Blog  </span></a> </li>


                <li><a href="{{ route('agent.list') }}"><span>Contact</span></a></li>

                <li>
               <a href="{{ route("agent.login") }}" class="btn btn-success"> Join Us</a>
           </li>
            </ul>
        </div>
    </nav>
